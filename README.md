...
- A ficha do lead com chat real **ou** lista importada (WhatsApp / origem `import`) não dispara print/espera/oferta no browser. O POST `/api/leads` só aceita nota, nome e temperatura num chat com `telegramChatId` — o quadro continua com o webhook e o cron.
