...
Pixel da landing — botão **Pixel Ads** no Dashboard, no topo de Telegram e de Configurações → Bot Telegram (`#pixel`). O snippet que se cola no anúncio é sempre o de produção, mesmo no painel local:
