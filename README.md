...
O volume Facebook → Telegram corre no Worker/KV. Não corras `003`/`004` no projecto Abilion — essas migrações pertencem ao recorte `001` que nunca existiu aqui. Conversas lista 80 e tem **Carregar mais** a partir dos leads hidratados. O poll da inbox continua a ser as 80 mais recentes.
