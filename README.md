...
- `/fluxo/funil/:id` — editor visual + runtime. Zoom/ajuste no canto superior direito; **Testar fluxo** no canto inferior direito — no telemóvel já não tapam um ao outro. **Publicar** fica bloqueado enquanto o CRM não confirma — um quadro leftover no cache não muda o que a Sté fala.
