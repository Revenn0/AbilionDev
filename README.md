...
- Dashboard (número grande de capturas), Telegram (joins / Facebook hoje), Conversas (faixa do funil e chips de filtro) e os contadores dos filtros de Leads mostram "…" enquanto o Worker ainda não hidratou. Conversas hidrata pelo número de conversas Telegram — cache só de WhatsApp não finge inbox vazia; inbox com erro e zero conversas é “Não li”, não “Nenhuma conversa”. O passo “Chat iniciado” do Analytics também. Não tratam zero como lista vazia.
