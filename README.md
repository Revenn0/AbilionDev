...
- `/telegram` — saúde do bot, webhook, snippet do pixel, simulação de /start. **Simular 100 /start** fica bloqueado se os leads ou os funis ainda não confirmaram — um quadro leftover no cache não solta o lote. Criar script de página no pixel também espera pelos funis confirmados.
