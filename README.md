...
- Dashboard (número grande de capturas), Telegram (joins / Facebook hoje), Conversas (faixa do funil e chips de filtro) e os contadores dos filtros de Leads mostram "…" enquanto o Worker ainda não hidratou. Conversas, o KPI Conversas do Dashboard, joins/Facebook hoje e o passo “Chat iniciado” do Analytics hidratam pelo recorte certo — cache só de WhatsApp não finge zero; inbox com erro e zero conversas é “…” / “Não li”. Não tratam zero como lista vazia.
