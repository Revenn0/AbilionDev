...
- `/utilizadores` — contas (dono cria / desliga / muda papel) e tokens MCP para Claude Code e outros agentes. Criar conta ou token com a lista por confirmar não finge equipa/token único — o formulário pede a leitura do Worker e o POST bem-sucedido volta a listar. GET de contas e de tokens correm à parte: um tokens 5xx já não esconde a equipa que o Worker devolveu.
